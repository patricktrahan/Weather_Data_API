...
app.post("/submit", async (req, res) => {
    try {
        ...
        const response = await axios.get(APIurl + `/points/${city[cityIndex].latitude}, ${city[cityIndex].longitude}`);
        const forecastUrl = response.data.properties.forecast;
        const forecastResponse = await axios.get(forecastUrl);
        const forecastData = forecastResponse.data.properties.periods;
        const cityName = response.data.properties.relativeLocation.properties.city;
        const stateName = response.data.properties.relativeLocation.properties.state;
